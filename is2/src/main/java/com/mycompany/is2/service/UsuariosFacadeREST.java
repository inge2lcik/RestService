 ...
 */
package com.mycompany.is2.service;

import com.mycompany.is2.Usuarios;
 ...
 */
@Stateless
@Path("com.mycompany.is2.usuarios")
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {

    @PersistenceContext(unitName = "com.mycompany_is2_war_1.0-SNAPSHOTPU")
